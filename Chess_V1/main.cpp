...
void movePiece(Piece**, string, string, int, map<string, int>&);        //Moves the piece to where the user selected
...
void displayCaptures(map<string, int>, map<string,int>);    //Shows which pieces have been captured by each player
...
int main() {
    ...
    map <string, int> player1_captures; //Stores the pieces that player 1 has captured
    map <string, int> player2_captures; //Stores the pieces that player 2 has captured
...
void displayCaptures(map<string, int> player1_captures, map<string,int> player2_captures){
...
void movePiece(Piece **board, string input, string moveTo, int player, map<string, int>& map){
